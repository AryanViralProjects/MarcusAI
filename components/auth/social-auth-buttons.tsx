...
export function SocialAuthButtons({ isSignUp = false, callbackUrl = "/" }: SocialAuthButtonsProps) {
  ...
  return (
    <div className="space-y-3">
      ...
      >
        <svg viewBox="0 0 438.549 438.549" width="16" height="16" className="shrink-0">
          <path
            fill="currentColor"
        ...
        {isLoading.github ? "Loading..." : `${actionText} with GitHub`}
      </Button>
    </div>
  )
}
